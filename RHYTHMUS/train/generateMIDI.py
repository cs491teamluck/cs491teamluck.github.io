...
def createMIDI():
    ...
    chosenSongName = str(sys.argv[1])
    predictionLength = int(sys.argv[2])

    # Loading the backupNotes generated by train.py
    with open('savedNotes/backupNotes', 'rb') as path:
    ...
    for item in glob.glob("trainMusics/" + str(chosenSongName) + ".mid"):
    ...
    midiStream.write('midi', fp='predicted_song.mid')
